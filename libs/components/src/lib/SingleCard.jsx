              ...
              {card.category === 'Monster' ? (
                <tbody>
                  ...
                  <tr className="single-card-date-row">
                    <td colSpan="5">Release Date: {dateToVerbose(card.tcgDate, false, false)}</td>
                  </tr>
                </tbody>
              ) : (
                <tbody>
                  <tr className="single-card-standard-row">
                    ...
                    <td className="single-card-label-inner-td">{card.category}</td>
                    <td className="single-card-symbol-td">
              ...
              <table>
                <tbody>
                  {prints.map((print, index) => (
                    <PrintRow key={print.id} index={index} print={print} />
                  ))}
                </tbody>
              </table>
            </div>
