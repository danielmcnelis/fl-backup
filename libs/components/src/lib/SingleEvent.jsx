  ...
  const topMainDeckCardsData = metagame.topMainDeckCards.length
    ? {
        labels: metagame.topMainDeckCards.map((e) =>
          e[0].length <= 30 ? e[0] : e[0].slice(0, 30).split(' ').slice(0, -1).join(' ')
        ),
        datasets: [
          {
  ...
  return (
    <div className="body">
      <div className="event-title-flexbox">
              ...
              <tr className="single-event-info-1">
                <td>
                  <div className="single-event-cell">
                    ...
                    <img style={{ width: '32px' }} src={'/assets/images/emojis/first.png'} />
                  </div>
                </td>
                <td className="desktop-only">
                  <div className="single-event-cell">
                    <div style={{ paddingRight: '7px' }}>
                      <b>Community:</b> {event.community}
                    </div>
              ...
              <tr className="single-event-info-2">
                <td>
                  <div className="single-event-cell">
                    <div
                      onClick={() => goToFormat()}
                      className="single-event-format-link"
                      style={{ paddingRight: '7px' }}
                    >
                      <b>Format:</b> {capitalize(event.formatName, true)}
                    </div>
                ...
                <td className="desktop-only">
                  <div className="single-event-cell">
                    <div style={{ paddingRight: '7px' }}>
                      <b>Winning Deck:</b> {capitalize(topDecks[0] ? topDecks[0].type : '', true)}
                    </div>
                  </div>
                </td>
                <td>
                  <div className="single-event-cell">
                    <div className="desktop-only">
                      <b>Date:</b> {dateToVerbose(event.startDate, false, false)}
                    </div>
                    <div id="single-event-uploaded-mobile" className="mobile-only">
                      <b>Date:</b> {dateToSimple(event.startDate)}
                    </div>
                  </div>
                </td>
              </tr>
        ...
        <img className="desktop-only" id="format-icon-large" src={`/assets/images/artworks/${event.format.icon}.jpg`} />
      </div>
      ...
      <div id="bracket">
        <div className="subcategory-title-flexbox">
          ...
          <h2 className="subheading">
            <b>{event.abbreviation}</b> Bracket:
          </h2>
        ...
        />
        <a className="bracket-link" href={event.referenceUrl} target="_blank">
      ...
      {topDecks.length ? (
        <div id="top-decks">
          <div className="subcategory-title-flexbox">
            <img style={{ width: '64px' }} src={`/assets/images/emojis/${event.format.icon}.png`} />
            <h2 className="subheading">
              <b>{event.abbreviation}</b> {topDecks.length > 1 ? `Top ${topDecks.length} Decks` : 'Winning Deck'}:
            </h2>
      ...
      {metagame.deckTypes.length ? (
        <div id="metagame-stats">
          <div className="subcategory-title-flexbox">
            <img style={{ width: '64px' }} src={`/assets/images/emojis/${event.format.icon}.png`} />
            <h2 className="subheading">
              <b>{event.abbreviation}</b> Metagame Stats:
            </h2>
          ...
          <div className="chart-flexbox">
            <div className="doughnut-container">
              ...
              <br />
              <Doughnut className="doughnut" height="500px" width="500px" data={deckTypeData} options={options} />
            </div>
            <div className="doughnut-container">
          ...
          <div className="chart-flexbox">
            <div className="bargraph-container">
              ...
              <br />
              <Bar className="bargraph" height="400px" width="500px" data={topMainDeckCardsData} options={options} />
            </div>
            <div className="bargraph-container">
              <h2>Top Side Deck Cards</h2>
              <br />
              <Bar className="bargraph" height="400px" width="500px" data={topSideDeckCardsData} options={options} />
            </div>
          </div>
        </div>
      ) : (
