  ...
  return (
    <div id="banlist" className="banlist">
      ...
      {forbidden.length ? (
        <div>
          <div id="forbidden" className="banlist-bubble">
            <div id="forbidden" className="banlist-category">
              Forbidden:
            </div>
            <div id="forbidden" className="banlist-flexbox">
              {forbidden.map((el) => (
                <CardImage width="72px" padding="1px" margin="0px" key={el.card.id} card={el.card} />
              ))}
            </div>
          </div>
        </div>
      ...
      <div id="limited" className="banlist-bubble">
        <div id="limited" className="banlist-category">
          Limited:
        </div>
      ...
      <div id="semi-limited" className="banlist-bubble">
        <div id="semi-limited" className="banlist-category">
          Semi-Limited:
        </div>
