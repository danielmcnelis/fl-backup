    ...
    <Link className="link" to={`/events/${event.abbreviation}`}>
      <div className="eventThumbnail">
        ...
        <div className="eventThumbnail-flexbox">
          <img className="eventThumbnail-image" src={`/assets/images/emojis/${event.format.icon}.png`} />
          <img
            className="eventThumbnail-player-pfp"
            src={`/assets/images/pfps/${winner.discordId}.png`}
            onError={(e) => {
              e.target.onerror = null
              e.target.src = 'https://cdn.discordapp.com/embed/avatars/1.png'
            }}
          />
          <img className="eventThumbnail-image" src={`/assets/images/logos/${event.community}.png`} />
        </div>
      </div>
    </Link>
  )
