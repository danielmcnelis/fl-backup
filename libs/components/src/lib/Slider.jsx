...
export const RangeSlider = (props) => {
  ...
  const points =
    props.type === 'range-slider' ? [props.min, props.max] : props.defaultValue ? props.defaultValue : props.max
  ...
  return (
    <div id="slider" className={classes.root} name="mySliders">
      <img src={props.symbol} alt={`${props.symbol} slider`} style={{ height: '24px', margin: '0px 12px 0px 0px' }} />
      <Typography
        style={{
          minWidth: '64px',
