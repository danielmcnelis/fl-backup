          ...
          <div className="vertical-ads-flexbox">
            ...
            >
              <div className="discord-link">
                <img src="/assets/images/logos/Discord.png" alt="Discord" style={{ height: '36%', width: '36%' }} />
            ...
            >
              <img src="/assets/images/logos/Twitter.png" alt="Twitter" style={{ height: '33%', width: '33%' }} />
            ...
            >
              <img src="/assets/images/logos/TCGPlayer.png" alt="TCG Player" style={{ height: '22%', width: '80%' }} />
